  ...
  return (
    <>
      {/* <form onSubmit={onSearch} className='flex items-center pt-10'>
        ...
        <button className='p-2 bg-zinc-400 text-zinc-800 cursor-pointer inline-flex rounded-r-lg leading-6 transition ease-in-out duration-150 shadow-sm font-bold text-center justify-center border border-transparent items-center hover:bg-zinc-800 hover:text-white hover:border hover:border-white'>
      ...
      <form onSubmit={onSearch} className=" max-w-5xl relative  lg:w-80 ">
        <input
          key={searchParams?.get('q')}
          type="text"
          name="search"
