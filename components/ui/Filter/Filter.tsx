    ...
    <div className='flex flex-row space-x-4 overflow-x-auto overflow-y-hidden whitespace-nowrap'>
      <form id='1' onSubmit={onSearch} className='flex items-center pt-10'>
        ...
        <button className={searchParams?.get('q') == undefined
          ? `p-2 bg-zinc-400 text-zinc-800 cursor-pointer inline-flex rounded-full leading-6 transition ease-in-out duration-150 shadow-sm font-bold text-center justify-center border border-transparent items-center hover:bg-zinc-800 hover:text-white hover:border hover:border-white`
          : `p-2 text-black-800 cursor-pointer inline-flex rounded-full leading-6 transition ease-in-out duration-150 shadow-sm text-center justify-center border border-neutral-900 items-center hover:bg-zinc-400 `}>
          ALL
        </button>
      </form>
