...
export default function Accordion({ data }: any) {
  return (
    <div className="mx-auto w-full max-w-6xl p-2 space-y-2">
      {data.map((gig: any) => (
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="flex w-full justify-between rounded-lg  px-4 py-2 text-left text-sm font-medium text-neutral-950 dark:text-neutral-100 border dark:border-neutral-800 hover:border-zinc-500 hover:bg-zinc-100 dark:hover:bg-neutral-800">
              ...
              <Disclosure.Panel className="flex flex-col px-4 pt-4 pb-2 text-sm rounded-lg text-neutral-950 bg-zinc-100 dark:bg-neutral-900 dark:text-gray-300 items-center">
                <div className='py-5 flex flex-col items-center space-x-2 space-y-5 justify-evenly'>
                  ...
                  <div className='flex space-x-2 items-center'>
                    <Link href={gig.link} target='_notarget' className={'bg-zinc-400 text-zinc-800 cursor-pointer inline-flex px-4 rounded-lg leading-6 transition ease-in-out duration-150 shadow-sm font-semibold text-center justify-center capitalize py-2 border border-transparent items-center hover:bg-zinc-800 hover:text-white hover:border hover:border-white'}>
                      Apply
                    </Link>
                    {gig.email &&
                      <Link href={`mailto:${gig.email}`} className={'bg-zinc-400 text-zinc-800 cursor-pointer inline-flex px-4 rounded-lg leading-6 transition ease-in-out duration-150 shadow-sm font-semibold text-center justify-center capitalize py-2 border border-transparent items-center hover:bg-zinc-800 hover:text-white hover:border hover:border-white'}>
                        Email
                      </Link>
                    }
                    <Link href={`/gig/${gig.id}`} target='_notarget' className={'bg-lime-800 text-white cursor-pointer inline-flex px-4 rounded-lg leading-6 transition ease-in-out duration-150 shadow-sm font-semibold text-center justify-center capitalize py-2 border border-transparent items-center hover:bg-lime-500 hover:text-black hover:border hover:border-white'}>
                      Learn more
                    </Link>
                  </div>
                </div>
                ...
                <div className='py-10 space-x-2 flex items-center'>
                  {gig.github &&
                    <Link href={gig.github} className={'bg-zinc-400 text-zinc-800 cursor-pointer inline-flex p-2 rounded-full leading-6 transition ease-in-out duration-150 shadow-sm font-semibold text-center justify-center capitalize border border-transparent items-center hover:bg-zinc-800 hover:text-white hover:border hover:border-white'}>
                  ...
                  {gig.twitter &&
                    <Link href={gig.twitter} className={'bg-zinc-400 text-zinc-800 cursor-pointer inline-flex p-2 rounded-full leading-6 transition ease-in-out duration-150 shadow-sm font-semibold text-center justify-center capitalize border border-transparent items-center hover:bg-zinc-800 hover:text-white hover:border hover:border-white'}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M22.46 6c-.77.35-1.6.58-2.46.69c.88-.53 1.56-1.37 1.88-2.38c-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29c0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15c0 1.49.75 2.81 1.91 3.56c-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93.07a4.28 4.28 0 0 0 4 2.98a8.521 8.521 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21C16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56c.84-.6 1.56-1.36 2.14-2.23Z" /></svg>
                    </Link>
                  }
                  {gig.linkedin &&
                    <Link href={gig.linkedin} className={'bg-zinc-400 text-zinc-800 cursor-pointer inline-flex p-2 rounded-full leading-6 transition ease-in-out duration-150 shadow-sm font-semibold text-center justify-center capitalize border border-transparent items-center hover:bg-zinc-800 hover:text-white hover:border hover:border-white'}>
